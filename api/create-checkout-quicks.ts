...
export default async function handler(
    ...
    const whatsappNumber = "5531985335573";
    const whatsappMessage = encodeURIComponent("Olá! Acabei de comprar o Quick Start Cineze e gostaria de dar início ao meu projeto de aceleração de resultados da minha empresa.");
            ...
            items: [
                {
                    ...
                    description: "Quick Start Cineze"
                }
            ],
            order_nsu: orderNsu,
