...
const questions = [
    ...
    },
    {
        ...
        type: "options",
        options: [
            "Saúde (nutricionista, fisioterapeuta, personal, etc.)",
            "Educação (escola, curso, autoescola)",
            "Serviços profissionais (contador, advogado, arquiteto)",
            "Varejo ou produto físico",
            "Outro"
        ],
