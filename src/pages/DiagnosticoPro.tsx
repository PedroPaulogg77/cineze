...
export default function DiagnosticoPro() {
    ...
    return (
        <div ref={pageRef} className="min-h-screen bg-[#050D18] text-white selection:bg-cyan-500/30 font-sans font-medium overflow-x-hidden flex flex-col">
                    ...
                    <ContainerScrollLite
                        titleComponent={
                            <>
                                ...
                                <div data-reveal="" style={{ transitionDelay: "0.3s" }} className="flex flex-col items-center w-full max-w-md mx-auto mb-16 md:mb-0 px-6 lg:px-0">
            ...
            <section className="w-full max-w-6xl mx-auto py-16 md:py-32 px-6 md:px-8">
                <div data-reveal="" className="text-center md:text-left mb-12 md:mb-16">
            ...
            <section className="w-full border-y border-white/5 bg-[#081320] py-16 md:py-32 px-6 md:px-8 shadow-inner relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div data-reveal="" className="text-center mb-12 md:mb-24">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20 mb-16 lg:mb-32">
                        ...
                        <div data-reveal="scale" style={{ transitionDelay: "0.1s" }} className="w-full lg:w-1/2">
                            <img
                                src={mockup4}
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
                        <div data-reveal="scale" style={{ transitionDelay: "0.1s" }} className="w-full lg:w-1/2 order-2 lg:order-1">
                            <img
                                src={mockup5}
            ...
            <section className="w-full bg-[#081320] py-16 md:py-24 px-6 md:px-8 border-y border-white/5 overflow-hidden">
                <div className="max-w-6xl mx-auto">
                    <div data-reveal="" className="text-center md:text-left mb-10 md:mb-16">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                        <div className="w-full lg:w-1/2 order-1 border border-white/10 bg-[#0B182B] rounded-3xl p-6 md:p-8 shadow-xl">
            ...
            <section className="w-full py-16 md:py-32 px-6 md:px-8 max-w-5xl mx-auto flex flex-col items-center">
                <div data-reveal="" className="text-center mb-10 md:mb-12 border-white/5 pt-2">
            ...
            {/* 8. GARANTIA & CTA FINAL */}
            <section className="w-full py-12 md:py-24 px-6 md:px-8 bg-[#050B14] border-t border-white/5">
                <div className="max-w-4xl mx-auto flex flex-col items-center text-center">

                    <div data-reveal="" className="bg-[#0A1628] border border-white/10 rounded-[2rem] p-6 md:p-8 w-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mb-16 md:mb-24 shadow-xl">
                    ...
                    <div data-reveal="" style={{ transitionDelay: "0.1s" }} className="w-full flex flex-col items-center px-2">
